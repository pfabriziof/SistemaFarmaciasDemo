    ...
    methods:{
        getOrdenCompra(){
            ...
            axios.get('/api/orden_compra/'+this.id_orden_compra).then((response) => {
                ...
                this.addForm.fill(this.orden_compra);
                this.addForm.id_proveedor      = this.orden_compra.proveedor.id_proveedor;
                this.addForm.nombre_proveedor  = this.orden_compra.proveedor.nombre;
                this.addForm.origen_dinero     = 1;
                ...
                //Orden Detalle
                response.data.orden_detalle.forEach((val)  => {
                    this.handleSubmitProduct(val.producto, val.cantidad, val.precio_unitario);
                });
