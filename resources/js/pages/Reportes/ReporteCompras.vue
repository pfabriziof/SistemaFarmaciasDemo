<template>
    <div class="flex-grow-1">
        ...
        <div class="d-flex align-center py-3">
            <h2 style="color: #37474F">Reporte Compras</h2>
        </div>
        ...
        <v-card class="mb-4" light style="padding: 15px">
            <v-row dense class="pa-2 align-center">
                <v-col v-if="$can('comprasreport_export', 'all')" class="text-right">
...
export default {
    data: () => ({
        ...
        headers: [
            ...
            { text: 'Proveedor', sortable: false, value: 'proveedor.nombre' },
            { text: 'Fecha Emisión', sortable: false, value: 'fecha_emision', align:'center' },
            { text: 'Nro. Factura', sortable: false, value: 'nro_factura', align:'center' },
    ...
    methods: {
        ...
        getExportData(){
            this.urlToReturn = '/exportarReporteCompraFormat/' + JSON.stringify(this.filter);
        },
        //--- End ---
